...
public interface XadminDeployConfigMapper extends BaseMapper<XadminDeployConfigDto, XadminDeployConfig> {
    @Mapping(target = "appName", source = "app.name")
    @Mapping(target = "appId", source = "app.appId")
    XadminDeployConfigDto toDto(XadminDeployConfig entity);
}
