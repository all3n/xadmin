...
public class ${className}Controller {
    ...
    @PreAuthorize("@xps.check('${changeClassName}:list')")
    ...
    @PreAuthorize("@xps.check('${changeClassName}:add')")
    ...
    @PreAuthorize("@xps.check('${changeClassName}:edit')")
    ...
    @PreAuthorize("@xps.check('${changeClassName}:del')")
