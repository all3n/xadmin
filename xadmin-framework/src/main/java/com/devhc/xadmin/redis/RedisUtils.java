 ...
 */
package com.devhc.xadmin.redis;
...
//            keys.addAll(redisTemplate.keys(new StringBuffer(prefix).append(id).toString()));
            keys.addAll(scanKeys(new StringBuffer(prefix).append(id).toString()));
        }
    ...
    public Set<Object> scanKeys(String pattern){
