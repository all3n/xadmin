...
public class MenuController {
    ...
    @PreAuthorize("@xps.check('menu:list')")
    ...
    @PreAuthorize("@xps.check('menu:list','roles:list')")
    ...
    @PostMapping
    @PreAuthorize("@xps.check('menu:add')")
    ...
    @PutMapping
    @PreAuthorize("@xps.check('menu:edit')")
    ...
    @DeleteMapping
    @PreAuthorize("@xps.check('menu:del')")
