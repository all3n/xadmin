...
public class RoleController {
    ...
    @GetMapping(value = "/{id}")
    @PreAuthorize("@xps.check('roles:list')")
    ...
    @PreAuthorize("@xps.check('role:list')")
    ...
    @PreAuthorize("@xps.check('roles:list','user:add','user:edit')")
    ...
    @PostMapping
    @PreAuthorize("@xps.check('roles:add')")
    ...
    @PutMapping
    @PreAuthorize("@xps.check('roles:edit')")
    ...
    @DeleteMapping
    @PreAuthorize("@xps.check('roles:del')")
